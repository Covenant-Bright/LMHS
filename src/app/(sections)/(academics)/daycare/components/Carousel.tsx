...
export default function Carousel({ autoSlideInterval = 6000 }: CarouselProps) {
  ...
  const slides = [
    {
      image: "/images/IMG_3734.webp",
      title: "Safe and Nurturing Environment",
      content:
        "At Miracle School’s Day Care, safety and emotional well-being are our top priorities. Our facility is designed to be child-friendly, with secure spaces, age-appropriate toys, and a team of trained caregivers who ensure children feel loved, supported, and protected. This creates a positive foundation for their growth.",
    },
    {
      image: "/images/IMG_3691.webp",
      title: "Developmentally-Appropriate Learning",
      content: "We believe in fostering children’s development through activities that match their unique stages of growth. Our Day Care program includes fun, educational play, arts, music, and early literacy exercises. These activities promote cognitive, emotional, and social development, ensuring children gain essential skills that prepare them for future learning experiences.",
    },
