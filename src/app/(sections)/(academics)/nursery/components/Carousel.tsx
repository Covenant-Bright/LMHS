...
export default function Carousel({ autoSlideInterval = 6000 }: CarouselProps) {
  ...
  const slides = [
    {
      image: "/images/IMG_3715.webp",
      title: "Holistic Development",
      content:
        "Our Nursery Classes focus on nurturing the whole child—emotionally, socially, physically, and intellectually. Activities are designed to promote self-expression, motor skills, problem-solving, and emotional regulation, ensuring children are well-rounded and prepared for future learning experiences.",
    },
    {
      image: "/images/IMG_3692.webp",
      title: " Social and Emotional Growth",
      content: "In our Nursery Classes, children are encouraged to build positive relationships with peers and teachers. Through group activities, cooperative play, and guided interactions, they develop essential social skills, empathy, and emotional regulation, creating a foundation for future emotional intelligence.",
    },
    {
      image: "/images/IMG_3726.webp",
      title: "Early Literacy and Numeracy Skills",
      content: "Our Nursery curriculum introduces foundational literacy and numeracy concepts through interactive storytelling, rhymes, and counting games. These early activities support language development, enhance communication skills, and help children recognize numbers and shapes, fostering a strong academic foundation for their learning journey.",
    },
  ]
