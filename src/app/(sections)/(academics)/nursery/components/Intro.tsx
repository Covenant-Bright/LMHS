        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a3d4c] mb-6">
              Learn More About Our Nursery Classes
            </h2>
            <p className="text-gray-600 mb-4">
              At Miracle School, our Nursery Classes offer a gentle introduction to formal education. We
              provide a warm and engaging environment where children develop essential social, emotional,
              and cognitive skills. Our experienced educators create a safe and nurturing space that
              encourages exploration, creativity, and early learning.
            </p>
            <p className="text-gray-600 mb-6">
              Our Nursery curriculum is designed to support each child&apos;s growth at their own pace. We lay the foundation for a lifelong love of
              learning, helping children develop confidence, curiosity, and foundational skills for their future educational journey.
            </p>
          </div>
          ...
          >
            ...
            >
              {brokenImages[0] ? (
                ...
                <Image
                  src="/images/IMG_3698.webp?height=400&width=400"
            ...
            >
              {brokenImages[1] ? (
                ...
                <Image
                  src="/images/IMG_3688.webp?height=200&width=200"
            ...
            >
              {brokenImages[2] ? (
                ...
                <Image
                  src="/images/IMG_3693.webp?height=200&width=200"
                  alt="Child playing"
                  fill
                  sizes="(max-width: 768px) 50vw, 200px"
                  className="object-cover"
