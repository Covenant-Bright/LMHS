        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a3d4c] mb-6">
              Learn More About Our Preparatory Classes
            </h2>
            <p className="text-gray-600 mb-4">
              Preparatory Classes that guide young learners smoothly from early childhood into nursery school. We focus on developing foundational skills in literacy, numeracy, and
              social interaction, ensuring that children are well-prepared for the academic challenges ahead.
              Through structured yet engaging activities, students are encouraged to explore new concepts and build their confidence.
            </p>
            <p className="text-gray-600 mb-6">
              In our preparatory environment, children are introduced to a balanced mix of learning and
              play. This helps nurture curiosity, independence, and a strong love for learning, setting the
              stage for a smooth transition into primary education.
            </p>
          </div>
          ...
          >
            ...
            >
              {brokenImages[0] ? (
                ...
                <Image
                  src="/images/IMG_3684.webp?height=400&width=400"
            ...
            >
              {brokenImages[1] ? (
                ...
                <Image
                  src="/images/IMG_3701.webp?height=200&width=200"
            ...
            >
              {brokenImages[2] ? (
                ...
                <Image
                  src="/images/IMG_3536.webp?height=200&width=200"
                  alt="Child playing"
                  fill
                  sizes="(max-width: 768px) 50vw, 200px"
                  className="object-cover"
