...
export default function Carousel({ autoSlideInterval = 6000 }: CarouselProps) {
  ...
  const slides = [
    {
      image: "/images/IMG_3710.webp",
      title: "Comprehensive Curriculum",
      content:
        "Our Primary Classes offer a well-rounded curriculum that includes core subjects such as math, science, language arts, and social studies. Each subject is designed to engage students and foster a deeper understanding, providing a strong academic foundation for future learning.",
    },
    {
      image: "/images/IMG_3675.webp",
      title: "Critical Thinking and Problem-Solving",
      content: "We encourage students to develop essential skills in critical thinking and problem-solving. Through collaborative activities, real-world challenges, and inquiry-based learning, students are equipped with the tools to analyze situations, think creatively, and make informed decisions, preparing them for future success.",
    },
    {
      image: "/images/IMG_3686.webp",
      title: "Holistic Development",
      content: "In addition to academics, our Primary Classes focus on students' emotional, social, and physical development. Through group work, sports, and creative arts, we promote teamwork, self-expression, and resilience, helping students become well-rounded individuals who are ready for future challenges.",
    },
  ]
