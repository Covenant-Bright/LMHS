        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Our Secondary School provides a dynamic and challenging learning environment for both
              junior and senior students. The junior years focus on building strong academic foundations
              across various subjects while encouraging exploration and personal growth. Students are
              guided to develop essential skills for critical thinking, collaboration, and independent learning.
            </p>
            <p className="text-gray-600 mb-6">
              For senior students, the curriculum becomes more specialized, preparing them for future
              academic and career paths. Emphasis is placed on advanced subjects, leadership opportunities,
              and preparing for national exams, ensuring students are ready for success in higher education and beyond.
            </p>
          </div>
          ...
          >
            ...
            >
              {brokenImages[0] ? (
                ...
                <Image
                  src="/images/IMG_3722.webp?height=400&width=400"
            ...
            >
              {brokenImages[1] ? (
                ...
                <Image
                  src="/images/IMG_3737.webp?height=200&width=200"
            ...
            >
              {brokenImages[2] ? (
                ...
                <Image
                  src="/images/IMG_3746.webp?height=200&width=200"
                  alt="Child playing"
                  fill
                  sizes="(max-width: 768px) 50vw, 200px"
                  className="object-cover"
